//
//  DiscoverTopCategoryTableViewController.m
//  Instashop
//
...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        self.categoriesArray = [[NSArray alloc] initWithArray:[[CategoriesAttributesHandler sharedCategoryAttributesHandler] getTopCategories]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.text = [self.categoriesArray objectAtIndex:indexPath.row];
    // Configure the cell...
