    ...
    */
    ...
    if (self.preloadedContent != nil)
    {
        ...
        if (self.preloadedContentView == nil)
        {
            ...
            self.preloadedContentView.text = @"Go to a store URL (Nike.com, Etsy.com, etc.) Navigate directly to where someone can purchase the product. Tap SAVE in the top right corner of the screen.";
