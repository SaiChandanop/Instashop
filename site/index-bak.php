...
<body>
	...
	<div id="wrapper">
		<div class="w1">
			<header id="header">
				<strong class="logo"><a href="#">Instashop</a></strong>
				
				<nav>
					<ul id="nav">
						<li><a href="#2" class="switch-btn">Sell on Instashop</a></li>
				...
				<h3 class="headertitle bodycopy">The marketplace for products discovered on Instagram</h3>
			</header>
			<div class="slideshow smartphone-hide">
				<div class="smask">
					<div class="slideset">
						<div class="slide emailform">
							<div class="slide-holder">
								<img src="images/phone-1.png" alt="image description">
								<img style="display:none" src="images/icon.jpg">
								<div class="text-align">
									<h1 class="logo-instashop"><a href="#">Instashop</a></h1>
									<h2 class="title">The marketplace for products discovered on Instagram</h2>
																		
									<div class="form-holder">

										<form action="mailchimp.php" class="email-form" method="POST">
											<fieldset>
																				<h3 class="bodycopy">Be the first to experience Instashop!</h3>
												<div class="row">
													<input type="text" value="Enter email for updates" class="required-email" name="email" />
									...
									<div class="sign-holder">
										...
										<strong class="st-title">Now help us spread the word!</strong>
										<ul class="socials-btn">
											<li><a href="#" class="facebook" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent(location.href), 'facebook-share-dialog', 'width=626,height=436'); return false;">Share</a></li>
										<li><a class="twitter" href="http://twitter.com/share?url=http%3A%2F%2Finstashop.com&text=I%20just%20signed%20up%20for%20%40Instashop%2C%20the%20marketplace%20for%20products%20discovered%20on%20Instagram%2E" target="_blank">Tweet</a><script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script></li>
...
//													echo ", id: " . $response["user"]["id"];
			...
			<div class="mobilecontent">
				<div class="screenshot"><a class="screenshot">Screenshot</a></div>
				<div class="form-holder">
					<form action="mailchimp.php" class="email-form" method="POST">
						<fieldset>
							<div class="row">
								<input type="text" value="Enter email for updates" class="required-email email" name="email" />
								<button class="emailbutton" type="submit" value="">SIGN UP</button>
							</div>
							<div class="row"><h3 class="">Be the first to experience Instashop!</h3></div>
						</fieldset>
					</form>
					<form action="sell.php">
						<input class="mobilebtn" type="submit" value="Sell on Instashop">
					</form>
					<form action="mailto:hello@instashop.com">
						<input class="mobilebtn" type="submit" value="Contact Us">
					</form>
				</div>
			...
			<footer id="footer">
				<div class="phone-holder">
					<a class="phone-holder">App Store</a>
				</div>
